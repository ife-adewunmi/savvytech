...
const HeroBanner = () => {
  return (
    <div className=" relative mb-40 mt-[80px] flex h-[590px] w-full items-center justify-between px-0 sm:pr-6 md:pl-11 lg:pl-20  xl:pl-52">
      {/* Left Grid */}
      <div className="z-50 flex h-full w-full basis-1/2 flex-col justify-center md:pr-11 lg:pr-20 xl:pr-3 ">
